...
<html>
    <head>
        ...
        <title>Lotes de Entrada Cadastrados no Repositório</title>
        <style>
            h2{
                text-align: center;
    ...
    <body>
        ...
        <table border="2" CELLPADDING=6 rules="all">
            <CAPTION>Lista de lotes cadastrados por data</CAPTION>
            <tr>
                <th>Data de cadastro</th><th>Código</th><th>Quantidade total</th>
            </tr>
            <c:forEach var="item" items="${lotesEntradaInseridos}">
                <tr>
                    ...
                    <td>
                        <center>${item.quantidadeTotal}</center>
                    </td>
                    <td>
